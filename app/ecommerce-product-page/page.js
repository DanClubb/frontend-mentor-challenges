      ...
      <header className={styles.header}>
        ...
        <div>
          <div className={styles.cartIcon}>
            <Image onClick={toggleCart} src={IMAGES.cart} alt="shopping cart" />
            {numItemsInCart > 0 && (
              <span className={styles.cartNotification}>{numItemsInCart}</span>
            )}
          </div>

          <Image src={IMAGES.avatar} width={32} height={32} alt="avatar" />
        </div>
      </header>
        ...
        <div className={styles.productInfo}>
          ...
          <div>
            ...
            <button className={styles.addToCart}>
              ...
              <div onClick={() => handleCartAddition(numItemsSelected)}>
                Add to cart
              </div>
            </button>
          </div>
