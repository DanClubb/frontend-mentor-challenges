        ...
        <section>
          <div className={styles.transform}>
            <div className={styles.about}>
              <h2 className={fraunces.className}>Transform your brand</h2>
              <p>
          ...
          <div className={styles.services}>
            <div className={styles.graphicDesign}>
              <h3 className={fraunces.className}>Graphic design</h3>
              <p className={styles.graphicDesignText}>
            ...
            <div className={styles.photography}>
              <h3 className={fraunces.className}>Photography</h3>
              <p className={styles.photographyText}>
          ...
          <section className={styles.testimonials}>
            ...
            <div>
              <div className={styles.person}>
                <Image src={IMAGES.emily} alt="Emily's profile picture " />
                <p>
                  We put our trust in Sunnyside and they delivered, making sure
                  our needs were met and deadlines were always hit.
                </p>
                <div className={styles.personInfo}>
                  <div className={`${fraunces.className} ${styles.personName}`}>
                    Emily R.
                  </div>
              ...
              <div className={styles.person}>
                <Image src={IMAGES.thomas} alt="Thomas' profile picture" />
                <p>
              ...
              <div className={styles.person}>
                <Image src={IMAGES.jennie} alt="Jennie's profile picture" />
                <p>
                ...
                <div className={styles.personInfo}>
                  ...
                  <div className={styles.personRole}>Business Owner</div>
                </div>
              </div>
            </div>
          </section>
