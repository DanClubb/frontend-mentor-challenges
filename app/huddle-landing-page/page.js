...
import styles from "./huddle-landing-page.module.css";
...
export default function huddleLandingPage() {
  return (
    <div className={`${styles.actingBody} ${openSans.className}`}>
      ...
      <main>
        ...
        <section className={`${styles.section}`}>
          ...
          <picture>
            <source
              srcSet={IMAGES.desktop.firstSectionBottom.src}
              media="(min-width:420px)"
            />
            <Image
              className={styles.curves}
        ...
        <section className={`${styles.section} ${styles.yourUsers}`}>
          ...
          <picture>
            <source
              srcSet={IMAGES.desktop.secondSectionBottom.src}
              media="(min-width:420px)"
            />
            <Image
              className={styles.curves}
      ...
      <footer>
        <picture>
          <source
            srcSet={IMAGES.desktop.footer.src}
            media="(min-width:420px)"
          />
          <Image
            className={styles.curves}
        ...
        <div className={styles.footerContent}>
          ...
          <form className={styles.newsletterForm}>
            <h3 className={poppins.className}>Newsletter</h3>
            <p>
